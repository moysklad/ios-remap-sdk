...
public extension MSBaseDocumentType {
    ...
    func templateBody(forDocument type: MSObjectType) -> [String: Any]? {
        ...
        case .customerorder, .demand, .invoiceout, .operation, .supply, .invoicein, .purchaseorder, .move, .inventory, .purchasereturn: break
        ...
        case .retaildemand, .retailsalesreturn, .retaildrawercashout, .purchasereturn, .retaildrawercashin: return nil
        }
    }
}
